    ...
    return(
        <>
            <section onClick={handleClick} className={ (enonciateur[idPhrase] === "Capitaine " ? `${styles.wrapper} ${(styles.wrapperCptn)}`: `${styles.wrapper} ${(styles.wrapperPasCptn)}` )}>
                <img className={ (enonciateur[idPhrase] === "Capitaine " ? `${styles.left} ` : `${styles.left} ${(styles.leftHidden)}`)} src='../../capitaine.png'></img>
                ...
                <img className={(enonciateur[idPhrase] === "Capitaine " ? `${styles.right} ${(styles.rightHidden)}` : `${styles.right}`)} src={( enonciateur[idPhrase] === "Matelot "? '../../matelot.png' : ( enonciateur[idPhrase] === "Duchesse "? '../../duchesse.png' : ( enonciateur[idPhrase] === "Titien " ? '../../Titien.png' : '../../Mozart.png')))}></img>
            </section>
        </>
