        ...
        <>  
            <section className="page">
                ...
                <section className='dialogue'>
                    ...
                    <Dialogue setIsLastPhrase={setIsLastPhrase}   dialogue={":Titien : Mon pinceau se mérite !/ :Titien : Je n’accepterai de le céder qu’à celui qui réalisera le plus beau tableau de moi./ :Capitaine : A toi de jouer " + prenom + " montre lui tes talents de de peintre !/ :Capitaine : A toi de jouer !"}></Dialogue>
